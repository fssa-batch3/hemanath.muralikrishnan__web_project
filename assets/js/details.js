...
function real_products(product){
    ...
    product_cat_title.innerHTML = product["category"]["title"];
    ...
    product_eng_name_p.innerText = product["name"]["english"];
    product_name_div.append(product_eng_name_p);

    // product tam name
    product_tam_name_p = document.createElement("p");
    product_tam_name_p.innerText = product["name"]["tamil"];
...
product_details.filter( function(rel) {
    ...
    if (rel["product"]["category"]["id"] == product_cat) {

        let product = rel["product"];
